...
Revision ID: 129c5deff377
Revises: 
Create Date: 2022-08-12 23:30:38.549844
...
def upgrade():
    ...
    op.add_column('Venue', sa.Column('looking_for_talents', sa.Boolean(), nullable=False))
